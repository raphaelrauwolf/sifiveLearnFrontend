...
// redux dependencies
import {
    getActiveCourse, getActiveModule, getActiveLesson,
...
/**
 * LessonEdit LitElement
 * template
 */
@customElement('lesson-edit')
class LessonEdit extends ConnectedComponent {
    ...
    stateChanged(state) {
        ...
        this.lesson = getActiveLesson(state);
