...
export const overviewFactory = (
        course, unsorted, nameCourse, stopEditing,
        addLessonToModule, addExistingContent,
        createLesson, editLesson, deleteLesson, sortLesson,
        createModule, editModule, deleteModule, sortModule,
) => {
    ...
    if (unsorted.length > 0) {
        ...
        unsortedContent = unsorted.map((unsortedContent) => {

            if (unsortedContent.type === 'lesson') {

                return html`<lesson-accordion .lesson=${unsortedContent.lesson}></lesson-accordion>`;

            } else if (unsortedContent.type === 'module') {
    ...
    return html`
        ...
        <div class="grid-container">
            ...
            <div class="content-container">
                ...
                <sifive-button @click="${() => addExistingContent()}" label="Add existing Content">
