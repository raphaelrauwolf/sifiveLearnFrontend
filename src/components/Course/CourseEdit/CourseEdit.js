...
import 'Components/Course/CourseContentBrowse';
...
const BROWSING_CONTENT = 'ACTION.BROWSING_CONTENT';
...
/**
 * CourseEdit LitElement
 * template
 */
@customElement('course-edit')
class CourseEdit extends ConnectedComponent {
    ...
    render() {
        ...
        switch (this.action) {
            ...
            case OVERVIEW:
                return overviewFactory(
                    this.course, this.unsorted, ::this.nameCourse, ::this.stopEditing,
                    ::this.addLessonToModule, ::this.addExistingContent,
            ...
            case BROWSING_CONTENT:
                return html`
                    ${topBarFactory(this.onTopBarBackClick)}
                    <course-content-browse
                        @add-lesson=${this.onAddUnsortedLesson}
                        @add-module=${this.onAddUnsortedModule}
                        @continue=${this.onBrowseContinue}
                        ></course-content-browse>`;
        ...
        return html`<!-- CourseEdit Component -->`;
    ...
    /**
     * Switch to BrowsingContent view
     */
    addExistingContent() {

        this.action = BROWSING_CONTENT;
    ...
    @eventOptions({ passive: true })
    onAddUnsortedLesson(event) {

        this.unsorted = [...this.unsorted, {
            type: 'lesson',
            lesson: event.detail.lesson,
        }];
